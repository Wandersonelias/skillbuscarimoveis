...
const LaunchRequestHandler = {
    ...
    handle(handlerInput) {
        const speakOutput = "Oi, Seja bem vindo ao seu buscador de imóveis por voz, vamos inciar nossa busca pelo Imóvel, dos seus sonhos? Você já conhece algumas das nossas opções de busca, se não vamos lá, Opção 1 - Buscar imoveis em sua cidade, Opção 2 - Buscar imoveis em sua cidade pelo bairro, Opção 3 - Buscar imoveis em sua cidade pelo tipo, Opção 4 - Buscar imoveis em sua cidade , Opção 5 - Buscar imoveis em sua cidade pelo bairro e valor, Opção 6 - Buscar imoveis em sua cidade pelo bairro tipo e valor, E fazer agendamento em algum imóvel de sua preferência, essa são algumas das opções que estaão disponíveis para você no Alexa Buscar Imóveis .";
...
const ImoveisCidadeIntentHandler = {
    ...
    try{
        ...
        for (const imovel of imoveis) {
            const imovelText = `Imóvel código ${imovel.id}, localizado na ${imovel.endereco}, no bairro ${imovel.bairro}, a seguinte descrição ${imovel.descricao} no valor de R$ ${imovel.valor}, Deseja agendar uma visita?`;
...
const CancelAndStopIntentHandler = {
    ...
    handle(handlerInput) {
        const speakOutput = 'Muito obrigado, por usar nossa aplicação!';
